    ...
    methods:{
        ...
        crearPago(id){
            ...
            .then(response => {
                ...
                // this.montoOriginal = this.pagoMiembro.monto
                //this.suma = this.montoOriginal
                //this.pagar = true
                //this.servicios = this.pagoMiembro.servicios;
                //this.mandarPlan = this.pagoMiembro.plan_entrenamiento["id"]
                // if(this.pagoMiembro.plan_entrenamiento == null){
                //     this.pe = true
                //     this.nombrePlan = 'NA'
                //     this.serviciosPlan = 'NA'
                // } else {
                //     this.pe = false
                //     this.serviciosPlan = this.pagoMiembro.plan_entrenamiento["servicios"]
                //     this.nombrePlan = this.pagoMiembro.plan_entrenamiento["nombre"]
                // }
            }).catch(error => {
                this.ventanaPago(false)
                console.log(error)
            ...
            .then(response => {
                ...
                this.montoOriginal = arreglo.monto
                this.suma = this.montoOriginal
                this.pagar = true
